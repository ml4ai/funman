...
def marginalize(b1, b2, var):
    ...
    if vars_b1 == vars_b2 and var in vars_b1:
        ...
        print("cannot marginalize: variables are not the same or marginalized variable is not in list.")
...
######## begin demos
    ...
    def test_marginalize_exception_2(self):
        ...
        # Manually make boxes for example.
        dict = {Parameter("x",1,2), Parameter("y",1,2), Parameter("w",1,2)}
        dict2 = {Parameter("x",1.5,2.5), Parameter("y",1.5,2.5), Parameter("z",1.5,2.5)}
        box1 = Box(dict)
        box2 = Box(dict2)
    ...
    def test_marginalize_1(self):
        ...
        # Manually make boxes for example.
        dict = {Parameter("x",1,2), Parameter("y",1,2), Parameter("z",1,2)}
        dict2 = {Parameter("x",1.5,2.5), Parameter("y",1.5,2.5), Parameter("z",5,6)}
        box1 = Box(dict)
        box2 = Box(dict2)
