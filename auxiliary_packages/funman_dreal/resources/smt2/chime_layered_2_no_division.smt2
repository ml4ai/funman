...
(push 1)
(assert (let ((.def_0 (<= 0.0 scale_1))) (let ((.def_1 (<= scale_1 1.0))) (let ((.def_2 (+ s_n_1 i_n_1))) (let ((.def_3 (+ .def_2 r_n_1))) (and (= n  (* quotient_1  .def_3)) (let ((.def_5 (= scale_1 quotient_1))) (let ((.def_6 (and .def_5 .def_1 .def_0))) .def_6))))))))
(push 1)
