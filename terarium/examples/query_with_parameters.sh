...
MODEL_PATH=../resources/amr/petrinet/mira/models/scenario2_a_beta_scale_static.json
REQUEST_PATH=../resources/amr/petrinet/mira/requests/request2_b_default_w_compartmental_constrs.json
...
FUNMAN_WORK_ID=$(./scripts/post-query.py $SERVER_URL $MODEL_PATH -r $REQUEST_PATH)
