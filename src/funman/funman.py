...
from funman.scenario import AnalysisScenario, AnalysisScenarioResult, ParameterSynthesisScenarioResult
...
class Funman(object):
    ...
    def synthesize_parameters(self, problem : ParameterSynthesisScenario, tolerance: float = 0.1) -> ParameterSynthesisScenarioResult:
        ...
        search = BoxSearch(problem)
        result = search.search(search.initial_box())
